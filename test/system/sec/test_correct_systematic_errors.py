...
class TestCorrectSystematicErrors(unittest.TestCase):
    ...
    def test_correct_systematic_errors_glob(self):
        ...
        self.assertEqual({'known': 7, 'reference': 19341, 'uncorrelated': 130, 'unobserved': 42}, sec_types)
        ...
        self.assertEqual({158829546}, unobserved_noise_sites.difference(positives))
