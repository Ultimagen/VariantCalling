...
class TestConvertCnvResultsToVcf:
    ...
    def test_convert_cnv_results_to_vcf(self, tmpdir):
        ...
        expected_out_vcf = pjoin(self.inputs_dir,'expected_EL-0059.cnv.vcf')
        ...
        out_vcf_file = pjoin(tmpdir,sample_name+'.cnv.vcf')
        
        assert filecmp.cmp(out_vcf_file, expected_out_vcf)
