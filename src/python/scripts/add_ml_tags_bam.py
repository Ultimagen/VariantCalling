...
ap.add_argument("--regressed_key", help='Regressed key (npy/bin)', required=False, type=str, default=None)
...
ap.add_argument("--n_classes", help='Number of probability classes (required if probability tensor or regressed key are bin)',
                type=int, required=False, default=None)
...
assert (args.probability_tensor.endswith("npy") 
	and
	args.regressed_key.endswith("npy")) or \
