...
ap.add_argument("--apply_model", help="If evaluate_concordance - which model should be applied", type=str, required=False)
...
try: 
    ...
    if args.evaluate_concordance: 
        ...
        concordance.to_hdf(args.output_file_prefix+".h5", key="scored_concordance")
