...
try:
    ...
    if args.blacklist_cg_insertions:
        cg_blacklist = python.modules.filtering.blacklist.blacklist_cg_insertions(df)
        blacklist = python.modules.filtering.blacklist.merge_blacklists([cg_blacklist, blacklist])
