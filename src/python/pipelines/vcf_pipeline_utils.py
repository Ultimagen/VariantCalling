...
def run_vcfeval_concordance(input_file: str, truth_file: str, output_prefix: str,
                            comparison_intervals: str,
                            ref_genome: str, ref_genome_sdf: str,
                            input_sample: str='NA12878', truth_sample='HG001',
                            ignore_filter: bool=False):
    ...
    ref_genome_sdf: str
        Fasta reference file generated by rtg format
    input_sample: str
        Name of the sample in our input_file
    truth_sample: str
        Name of the sample in the truth file
    ...
    if not(os.path.exists(SDF_path) and os.path.isdir(SDF_path)):
        tar = tarfile.open(ref_genome_sdf)
        tar.extractall(SDF_path)
        tar.close()
