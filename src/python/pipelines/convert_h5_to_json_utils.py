...
def preprocess_json_for_mongodb(json_string):
    result = json_string
...
def convert_h5_to_json(input_h5_filename, root_element, mongodb_preprocessing, ignored_h5_key_substring):
