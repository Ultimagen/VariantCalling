...
ap.add_argument(
    "--input_h5", help="Metrics input h5 file name", required=True, type=str
)
ap.add_argument(
    "--output_json", help="Metrics output json file name", required=True, type=str
)
ap.add_argument(
    "--root_element", help="Root element of the output JSON", required=True, type=str
)
ap.add_argument(
...
json_string = metrics_utils.convert_h5_to_json(
    input_h5_filename, root_element, ignored_h5_key_substring
)
