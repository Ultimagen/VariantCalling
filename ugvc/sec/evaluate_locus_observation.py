...
from ugvc.utils.pysam_utils import get_filtered_alleles_str


def evaluate_observation(observed_variant: VariantRecord,
                         expected_distribution: ConditionalAlleleDistribution) -> List[SECRecord]:
    """
    ...
    for conditioned_genotype in allele_counts_dict:
        sec_records.append(SECRecord(chrom=chrom,
                                     pos=pos,
    ...
    if '0/0' not in allele_counts_dict:
        ...
        expected_distribution = ConditionalAlleleDistribution(observed_alleles,
